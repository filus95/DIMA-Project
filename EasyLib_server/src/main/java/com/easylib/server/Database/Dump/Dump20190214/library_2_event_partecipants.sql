...
CREATE TABLE `event_partecipants` (
  ...
  CONSTRAINT `event_partecipants_events_id_fk` FOREIGN KEY (`event_id`) REFERENCES `library_1`.`events` (`id`)
...
INSERT INTO `event_partecipants` VALUES (1,1,1),(2,2,1),(6,1,1),(11,3,31);
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `update_available_seats_ins` AFTER INSERT ON `event_partecipants` FOR EACH ROW begin
    ...
    update library_2.events set library_2.events.seats = library_2.events.seats - 1
    where library_2.events.id = NEW.event_id;
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `update_available_seats_del` AFTER DELETE ON `event_partecipants` FOR EACH ROW begin
    ...
    update library_2.events set library_2.events.seats = library_2.events.seats + 1
    where library_2.events.id = OLD.event_id;
...
-- Dump completed on 2019-02-14 11:14:17
