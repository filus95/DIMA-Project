...
INSERT INTO `waitinglist` VALUES (1,0,'1626366543',0,'2019-01-12 17:29:32','2018-12-27','2018-12-27',1),(2,0,'1626366543',0,'2019-01-12 17:45:28','2018-12-27','2018-12-27',1),(3,0,'1626366543',3,'2019-01-12 17:53:41','2018-12-27','2018-12-27',1),(4,0,'1626366543',4,'2019-01-12 17:53:54','2018-12-27','2018-12-27',1),(5,0,'1626366543',5,'2019-01-12 17:57:55','2018-12-27','2018-12-27',1),(6,0,'1626366543',6,'2019-01-12 17:58:45','2018-12-27','2018-12-27',1);
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `on_insert_waiting_person` BEFORE INSERT ON `waitinglist` FOR EACH ROW begin
    ...
    if NEW.waiting_position = 1 then
      update library_1.books set wating_list = true where book_identifier = NEW.book_identifier;
    end if;
  end */;;
DELIMITER ;
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `update_waitinglist_position` AFTER DELETE ON `waitinglist` FOR EACH ROW begin
    if OLD.waiting_position = 1 then
      update library_1.books set wating_list = false where book_identifier = OLD.book_identifier;
    end if;
