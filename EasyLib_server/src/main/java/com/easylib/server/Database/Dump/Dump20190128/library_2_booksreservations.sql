...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `update_on_reservation` AFTER INSERT ON `booksreservations` FOR EACH ROW BEGIN
    ...
    where library_2.books.book_identifier = NEW.book_identifier;
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `insert_new_reserved_person` BEFORE DELETE ON `booksreservations` FOR EACH ROW begin
    ...
    if cond > 0 then
      ...
      select waitinglist.quantity into v_quantity from library_2.waitinglist where library_2.waitinglist.book_identifier =
                                                                                   OLD.book_identifier and waiting_position = 1;
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `update_count_on_delivering` AFTER DELETE ON `booksreservations` FOR EACH ROW begin
    ...
    where library_2.books.book_identifier = OLD.book_identifier;
...
-- Dump completed on 2019-01-28 18:54:11
